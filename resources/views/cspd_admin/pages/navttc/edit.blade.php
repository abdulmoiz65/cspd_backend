...
<div class="table-header">
            <div>
                <h2><i class="fas fa-list-alt me-2"></i>EDIT NAVTTC Programs</h2>
            </div>
        </div>
...
<form method="POST" action="{{ route('admin.navttc.update', $program->id) }}">
    @csrf
    @method('PUT')
    ...
    <div class="mb-3">
        ...
        >{{ old('required_qualification', $program->required_qualification) }}</textarea>
    ...
    <div class="mb-3">
        ...
        <input 
            type="url" 
            name="apply_link"
            value="{{ old('apply_link', $program->apply_link) }}"
    ...
    <a href="{{ route('admin.navttc.index') }}" class="btn btn-secondary">
        Cancel
    </a>
</form>
</div>
